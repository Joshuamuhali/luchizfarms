import { Phone, MapPin, Home, Instagram, Facebook } from "lucide-react";
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <img
                ...
                className="w-12 h-12 object-contain rounded-xl bg-white/10"
              />
              <div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-2">
                <img src={LOGO_URL} alt="Luchiz Farm" className="w-5 h-5 object-contain rounded" />
                <span className="text-white font-medium">Good food from our farm</span>
                <img src={LOGO_URL} alt="" aria-hidden="true" className="w-5 h-5 object-contain rounded" />
              </div>
            </div>
