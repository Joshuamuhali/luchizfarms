...
import { Phone, MessageCircle, Wheat, ArrowRight, Leaf, ChevronLeft, ChevronRight, ShoppingCart } from "lucide-react";
import { useAuth } from "@/contexts/AuthContext";
import { WHATSAPP_NUMBER, PAYMENT_PHONE_DISPLAY, HERO_IMAGE_URL } from "@/lib/constants";

const heroImage = HERO_IMAGE_URL;
const PHONE_NUMBER = PAYMENT_PHONE_DISPLAY;
          ...
          <div className="text-center space-y-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center opacity-0 animate-fade-up" style={{ animationDelay: "600ms" }}>
              ...
              >
                ...
                {user ? "Shop & order" : "Create account"}
              ...
              <a
                ...
                className="border-2 border-white/40 text-white font-semibold px-6 py-4 rounded-xl hover:bg-white/10 transition-all flex items-center gap-2"
              >
